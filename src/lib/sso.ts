 ...
 * Congregation and VBS signs in once rather than twice.
 *
 ...
 * install.
 *
 * **It is one more provider, never a replacement.** Google, Microsoft Entra,
 * the emailed link and email-and-password all keep working. With no
 * `AUTH0_ISSUER` the provider is not registered at all and this file changes
 * nothing.
 *
